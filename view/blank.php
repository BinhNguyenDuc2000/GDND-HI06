    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="/TreeCare/Home" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>TreeCare</h3>
                </a>
                <div class="navbar-nav w-100">
                    <a href="Dashboard" class="nav-item nav-link" id="dashboard"><i class="fa fa-tachometer-alt me-2"></i>Bảng tin</a>
                    <a href="Task?method=list" class="nav-item nav-link" id="task"><i class="fa fa-tachometer-alt me-2"></i>Công việc</a>
                    <a href="KPI" class="nav-item nav-link" id="kpi"><i class="fa fa-tachometer-alt me-2"></i>KPI</a>
                    <a href="Help" class="nav-item nav-link" id="help"><i class="fa fa-tachometer-alt me-2"></i>Hướng dẫn</a>
                </div>
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="d-none d-md-flex ms-4 text-center">
                        ...
                        <p>Màn hình cho <?php echo ($data["type"]);?></p>
                    </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="view/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="view/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">TreeCare</a>, All Right Reserved. 
                        </div>
